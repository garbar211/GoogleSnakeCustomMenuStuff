alert("WELCOME! If there is an error please report it to me. Via gmail would be nice; with the explination on what is wrong. Any suggestions can also be sent my way! LAST UPDATED: WED, NOV 23 @ 12:24 EST (Added Dark mode(hot); Bypassed images(May be broke...); Apple count may be fixed idk...");
